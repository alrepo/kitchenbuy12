    ...
    document.querySelector("#bookingButton").addEventListener("click", function()
      {
        if (nameIsValid && phoneIsValid && DateAndTimeAreValid)
        {
          ...
          clientOrder ={clientID:clientID, supplierID:supplierID, clientName:clientName, clientPhone:clientPhone, clientBookingDateAndTime:clientBookingDateAndTime, clientRequestedProducts:submittedOrder};
